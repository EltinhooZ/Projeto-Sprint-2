...
CREATE TABLE `empresa` (
  ...
  CONSTRAINT `empresa_ibfk_2` FOREIGN KEY (`fkSetor`) REFERENCES `setor` (`idSetor`)
...
CREATE TABLE `sensor` (
  ...
  CONSTRAINT `sensor_ibfk_1` FOREIGN KEY (`fkEmpresa`) REFERENCES `empresa` (`cnpj`)
...
CREATE TABLE `setor` (
  ...
  CONSTRAINT `setor_ibfk_1` FOREIGN KEY (`fkSensor`) REFERENCES `sensor` (`idSensor`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-04-16 19:40:53
